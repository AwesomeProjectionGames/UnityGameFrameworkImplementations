...
Implement the Bus and Depdendency Injection patterns to enable decoupled communication between different game systems and components.

## Communication mechanism philosophy

| Mechanism                          | Use Case                                                               | Scope / Lifetime                   | Pros                                                                   | Cons                                                                            | Examples                                                          |
|------------------------------------|------------------------------------------------------------------------| ---------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------- | -------------------------------------------------------------------- |
| **Interface**                      | Stable capability or contract (what an entity *is*, use with DI)       | Component / prefab, compile-time   | Strong typing, compile-time safety, testable                           | Requires explicit declaration per capability; can explode if many small signals | `IMovementMotor`, `IGroundState`, `IHealth`, `IWeapon`               |
...
| **UnityEvent / SimpleObservables** | Designer-authored or disposable logic                                  | Prefab / scene                     | Easy for non-programmers, Inspector-visible, visual wiring             | Reflection-based, slower, less safe for frequent events, hidden contracts       | Cinematics, triggers, one-off level interactions, cutscene animations |
